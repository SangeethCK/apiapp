...
List<Restaurent> restaurentFromJson(String str) => List<Restaurent>.from(json.decode(str).map((x) => Restaurent.fromJson(x)));

String restaurentToJson(List<Restaurent> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class CategoryDish {
    ...
    factory CategoryDish.fromJson(Map<String, dynamic> json) => CategoryDish(
        ...
        nexturl: json["nexturl"] ?? null, addonCat: [],
